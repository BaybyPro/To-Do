        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div class="relative flex h-16 items-center justify-between">
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
              <!-- Mobile menu button-->
              <button type="button" 
                onclick="toggleMenuMovil()" {{-- función para mostrar/ocultar el menú en mobil --}}
                ...
                <!-- Icon when menu is closed (burger icon) -->
            ...
            <!-- Menú desplegable de pantalla móvil -->
            <div class="sm:hidden max-h-0 overflow-hidden transition-all duration-500 ease-in-out" id="mobile-menu">
